...
type TabType = "pending" | "active" | "history" | "availability";
        ...
        <div className="px-4 pt-4">
          ...
          <div className="flex gap-2 mb-4 overflow-x-auto -mx-4 px-4 pb-2">
            {[
              ...
              { key: "availability", label: "Availability", count: 0, icon: CalendarDays },
            ].map((tab) => (
              <Button
                key={tab.key}
                ...
                <CardContent className="p-4">
                  ...
                  {blockedDates.length === 0 ? (
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {blockedDates.filter((d) => d >= new Date()).length > 8 && (
                        <Badge variant="secondary">
                          +{blockedDates.filter((d) => d >= new Date()).length - 8} more
                        </Badge>
                      )}
                    </div>
                  )}
